# Rejseplanen-API Python
 Python scripts til nemt at benyttet rejseplanens API. Det er målet at lave en script til alle de forskellige kald som Rejseplanens API har men det er lidt en work-in-progress.
 ...
 >
 > - 3. Vælg den script du ønsker at benytte i API-calls mappen, og indsæt variablerne.
